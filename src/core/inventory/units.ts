...
export const units: readonly UnitDefinition[] = [
  ...
  },
  {
    ...
    symbol: 'oz',
    decimalPlaces: 6,
    canonicalNumerator: '28349523125',
    canonicalDenominator: '1000000',
  },
  {
    id: 'pound',
    code: 'LBR',
  ...
  },
  {
    ...
    symbol: 'gal',
    decimalPlaces: 6,
    canonicalNumerator: '3785411784',
    canonicalDenominator: '1000000',
  },
  ...(
    [
      { id: 'bag', name: 'Bag', nameMy: 'အိတ်', symbol: 'bag' },
      { id: 'bottle', name: 'Bottle', nameMy: 'ပုလင်း', symbol: 'btl' },
      { id: 'pack', name: 'Pack', nameMy: 'ထုပ်', symbol: 'pack' },
      { id: 'case', name: 'Case', nameMy: 'ဖာ', symbol: 'case' },
    ] as const
  ).map(({ id, name, nameMy, symbol }) => ({
    id,
